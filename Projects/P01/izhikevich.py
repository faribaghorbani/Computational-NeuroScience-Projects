...
class Izhikevich(Behavior):
    ...
    def forward(self, neurons):
        ...
        neurons.v = neurons.v + deriv_v * neurons.network.dt
        neurons.u = neurons.u + deriv_u * neurons.network.dt
        ...
        neurons.u[neurons.spike] = neurons.u[neurons.spike] + neurons.vector(self.d)
